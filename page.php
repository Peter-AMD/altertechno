                           ...
                           <ul> <!-- SLIDE  -->
                                ...
                                <li id="Align" data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off">
                                    ...
                                    <div class="tp-caption white_large_shadow_robo tp-fade tp-resizeme"
                                        ...
                                        data-endelementdelay="0.1"
                                        data-endspeed="1000"
                                        style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap; text-align:center; margin-left: -10%">Sydney | Canada | Germany | Singapore | Hong Kong
                                    </div>
                   ...
                   <!--  </div>
					...
					<section id="events" class="content">
                        ...
                        <div class="content-main fullwidth-section dt-sc-parallax-section services-parallax dark-bg" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/Background/party.jpg'); background-repeat: no-repeat; background-size:cover; background-attachment: fixed;">
                            ...
                            <!-- <div class="fullwidth-section dt-sc-parallax-section testimonial-parallax dark-bg" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/Background/autria.jpg"'">
                                <div class="container">
                    ...
                    <div class="content-main">
                        ...
                        <div class="social-media type1">
                            <ul class="aligncenter">
                                ...
                                <li class="dt-sc-one-fifth column no-space"><a href="#" class="dt-sc-tooltip-top twitter" title="Twitter"><i class="fa fa-twitter"></i></a></li>
